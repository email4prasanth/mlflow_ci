...
dagshub_token = os.environ("DAGASHUB_TOKEN")
...
class TestModelLoading(unittest.TestCase):
    ...
    def test_model_in_loading(self):
        client = MlflowClient()
        versions = client.get_model_versions(model_name, stages = "Staging")
        if not versions:
                self.fail("No model found in Staging stage, skipping model testing")
        ...
        print("model successfully loaded from {logged_model}.")
